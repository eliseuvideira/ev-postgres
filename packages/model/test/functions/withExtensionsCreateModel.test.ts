...
import { withExtensionsCreateModel } from "../../src/functions/withExtensionsCreateModel";
...
describe("withExtensionsCreateModel", () => {
  it("creates a model", async () => {
    ...
    expect(model.extension).toEqual(extension);
